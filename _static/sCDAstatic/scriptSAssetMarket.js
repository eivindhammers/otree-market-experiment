    ...
    function liveRecv(data) {
        ...
        elBidsTableBody.html(bids.map(e => `<tr id='offerID${e[2]}' value=${e[2]} data-value=${e[3]} data-custom="1"><td value=${e[1]}>${e[1]} stk </td><td value=${e[0]}>${cu(e[0])}</td></tr>`).join(''))
        elAsksTableBody.html(asks.map(e => `<tr id='offerID${e[2]}' value=${e[2]} data-value=${e[3]} data-custom="0"><td value=${e[1]}>${e[1]} stk </td><td value=${e[0]}>${cu(e[0])}</td></tr>`).join(''))
